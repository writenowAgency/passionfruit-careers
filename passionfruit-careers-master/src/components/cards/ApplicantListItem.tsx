...
const styles = StyleSheet.create({
  container: {
    ...
    shadowRadius: 8,
    elevation: 3,
    borderWidth: 1, // Only top/right/bottom will show due to left override
    borderColor: colors.borderLight, // But we need to be careful with borderLeftWidth
    // To handle border properly with borderLeftWidth, we might need nested view or just rely on shadow for depth
