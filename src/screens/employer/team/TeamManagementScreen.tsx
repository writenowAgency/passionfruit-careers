...
const TeamManagementScreen: React.FC = () => {
  ...
  const [teamMembers, setTeamMembers] = useState<TeamMember[]>([
    ...
    },
    {
      id: 2,
      name: 'Sarah Johnson',
      email: 'sarah.j@passionfruit.com',
      role: 'admin',
      status: 'active',
      joinedAt: '2024-02-20',
    ...
    },
    {
      id: 3,
      name: 'Michael Chen',
      email: 'michael.c@passionfruit.com',
      role: 'recruiter',
      status: 'active',
      joinedAt: '2024-03-10',
    ...
    },
    {
      id: 4,
      name: 'Emily Davis',
      email: 'emily.d@passionfruit.com',
      role: 'manager',
      status: 'pending',
      joinedAt: '2024-12-10',
    },
  ...
  const handleResendInvite = (member: TeamMember) => {
    Alert.alert('Success', `Invitation resent to ${member.email}`);
  };
  ...
  const handleChangeRole = (member: TeamMember, newRole: TeamMember['role']) => {
    ...
    setMenuVisible({});
    Alert.alert('Success', `${member.name}'s role updated to ${ROLE_LABELS[newRole]}`);
  };
